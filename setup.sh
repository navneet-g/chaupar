...
EOF
    ...
    log "WARNING" "IMPORTANT: Update Firebase configuration values in .env.local"
}
...
main() {
    ...
    log "INFO" "Next steps:"
    log "INFO" "1. Update Firebase configuration in .env.local"
    log "INFO" "2. Enable Google Authentication in Firebase Console"
    log "INFO" "3. Test with: npm run dev"
    log "INFO" "4. Deploy with: firebase deploy"
